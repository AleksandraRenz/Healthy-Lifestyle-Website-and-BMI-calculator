function calculate_Bmi_kg()
// This is a script to calculate your BMI using kg & cm
// Alex Renz: June 2021
{
let inputWeight = 0;
let inputHeight = 0;
...
{
    errorFlag = 'N';
    inputWeight= prompt('Enter your weight in kg', 0);
...
{
    errorFlag = 'N';
    inputHeight = prompt('Enter your height in cm', 0);
...
outputBmi = (inputWeight /inputHeight/ inputHeight)* 10000
